    ...
    return (
        <div className="flex flex-col md:flex-row">
            <section className="mr-[5rem]">
                <div className={`flex-1 p-4 cursor-pointer text-lg ${activeTab === 1 ? "font-bold" : ""}`} onClick={() => handleTabClick(1)}>Leave a Review</div>
                        ...
                        {userInfo ? (
                            <form onSubmit={submitHandler}>
                                <div className="my-2">
                                    ...
                                    <select id="rating" required value={rating} onChange={e => setRating(e.target.value)} className="p-2 rounded-lg xl:w-[40rem] text-black">
                    ...
                    <>
                        ...
                        <div>
                            {product.reviews.map((review) => (
                                <div key={review._id} className="bg-[#1A1A1A] p-4 rounded-lg xl:ml-[2rem] sm:ml-[0rem] xl:w-[30rem] sm:w-[20rem] mb-5">
