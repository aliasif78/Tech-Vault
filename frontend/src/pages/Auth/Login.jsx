                ...
                <div className='mr-[4rem] mt-[5rem]'>
                    ...
                    <form className='container w-[40rem]' onSubmit={submitHandler}>
                        <div className="my-[2rem]">
                            ...
                            <input type="email" id='email' className='mt-1 p-2 border rounded w-full text-black' value={email} onChange={e => setEmail(e.target.value)} />
                        </div>

                        <div className="my-[2rem]">
                            <label htmlFor="password" className='block text-sm font-medium text-white'>Password</label>

                            <input type="password" id='password' className='mt-1 p-2 border rounded w-full text-black' value={password} onChange={e => setPassword(e.target.value)} />
                        </div>
