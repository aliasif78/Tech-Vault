    ...
    return (
        <div className="p-3">
            ...
            <div className="flex justify-between">
                <button onClick={handleSubmit} className="bg-pink-600 px-4 py-2 text-white rounded-lg hover:bg-pink-800 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-opacity-50">{buttonText}</button>
